...
internal fun sogKnotsForDisplay(speedMps: Double): Double? =
    metersPerSecondToKnots(speedMps)?.let { round(it * 10.0) / 10.0 }

internal fun cogDegreesForDisplay(bearingDegrees: Double): Int? =
